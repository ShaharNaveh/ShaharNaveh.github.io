...
While a certificate might help you secure a job interview or bypass the [ATS](https://en.m.wikipedia.org/wiki/Applicant_tracking_system) :wink:, a [low-value certificate]({{< ref "#expensive-and-low-value-certificate" >}} "low-value certificate") won't impress the interviewer.
